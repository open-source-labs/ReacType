...
export const { addComponent, addChild, changeFocus, changeTailwind, changePosition, updateStateUsed, resetAllState, updateUseContext, updateAttributes, deleteChild, setInitialState, openProject, addElement, undo, redo } = appStateSlice.actions;
