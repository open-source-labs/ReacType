...
const renderChildren = (children: ChildElement[]) => {
  ...
  return children.map((child: ChildElement, i: number) => {
    ...
    else if (type === 'HTML Element' && typeId !== 11 && typeId !== 1000 && typeId !== 2 && typeId !== 3 && typeId !== 14 && typeId !== 15 && typeId !== 16 && typeId != 17 &&  typeId != 18) {
      return (
        <DirectChildHTML
          childId={childId}
          type={type}
    ...
    else if (type === 'HTML Element' && (typeId === 11 || typeId === 2 || typeId === 3 || typeId === 14 || typeId === 15 || typeId === 16 || typeId === 17 || typeId === 18)) {
      return (       
