...
/**
 * ComponentTree component displays the tutorial for the React component tree, providing a visual representation of the component hierarchy.
 *
 * @param {object} props - Component props.
 * @param {object} props.classes - CSS classes for styling.
 * @param {Function} props.setPage - Function to set the current page.
 * @returns {JSX.Element} ComponentTree component JSX.
 */
const ComponentTree: React.FC<{
  ...
  <div className={classes.wrapper}>
    ...
    <p className={classes.text}>
      The component tree provides the developer with a visual representation
      of the component hierarchy. The tree updates in real time as the
      developer adds or deletes components and HTML elements.
    </p>
    ...
    <hr />
    <p className={classes.text}>
      Each tree begins with a root node. The current page that is selected
    ...
    <p className={classes.text}>
      ...
      are shown attached to the current page along with their subtrees of
      components and{' '}
      <span
        className={classes.notLink}
    ...
    <hr />
    <p className={classes.text}>
      You can also view the tree for each{' '}
      <span
        className={classes.notLink}
        onClick={() => setPage('Reusable Components')}
      >
