  ...
  return (
    <div className={classes.wrapper}>
      ...
      <p className={classes.text}>
        ...
        the elements you want into the <span className={classes.notLink} onClick={() => setPage('Canvas')} >canvas</span> of the page you're on. (Note the
      ...
      <p className={classes.text}>Delete the page by simply clicking the button.</p>
      <hr/>
    </div>
  );
};
