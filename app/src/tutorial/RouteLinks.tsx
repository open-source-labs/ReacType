 ...
 * @returns {JSX.Element} RouteLinks component JSX.
 */
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <p className={classes.text}>
        Users are able to drag-and-drop 'Link' components onto the canvas which
        allow navigation to different{' '}
      ...
      <hr />
      <p className={classes.text}>
        Each page found in the '
        <span className={classes.notLink} onClick={() => setPage('Pages')}>
          Pages
        </span>
        ' section can be navigated to via a 'Link'. Clicking on the 'Route Link'
        dropdown will display all the created pages in your application.
      </p>
      <div className={classes.imgWrapper}>
      ...
      <hr />
      <p className={classes.text}>
        The code generator will automatically{' '}
        <code>import Link from 'next/link'</code> and create your Link component
        in the bottom panel.
      </p>
      <div className={classes.imgWrapper}>
      ...
      <hr />
      <p className={classes.text}>
        Clicking on a Link component on the{' '}
        <span className={classes.notLink} onClick={() => setPage('Canvas')}>
          canvas
        </span>{' '}
        will navigate to the corresponding page.
      </p>
      <div className={classes.imgWrapper}>
      ...
      <hr />
      <p className={classes.text}>
        For more information on 'Link' for Next.js, please{' '}
        <a
          href="https://nextjs.org/docs/api-reference/next/link"
          target="_blank"
        >
          visit the official documentation section at nextjs.org.
        </a>{' '}
        For more information on 'Link' for Gatsby.js, please{' '}
        <a
          href="https://www.gatsbyjs.com/docs/reference/built-in-components/gatsby-link/"
          target="_blank"
        >
          visit the official documentation section at www.gatsbyjs.com.
        </a>
      </p>
      <hr />
    </div>
