...
describe('Testing componentReducer functionality for stateManagement tab', () => {
  ...
  describe('ADD PASSEDINPROPS test', () => {
    ...
    it(`parent component should have a state id: 'App-testAppState' `, () => {
      expect(parentComponent.children[1].passedInProps[0].id).toEqual('App-testAppState');
    });
    it(`parent component should have a state key: 'testAppState' `, () => {
      expect(parentComponent.children[1].passedInProps[0].key).toEqual('testAppState');
    });
    ...
    it(`parent component should have a state value type: 'number'`, () => {
      expect(parentComponent.children[1].passedInProps[0].type).toEqual('number');
    });
  });
